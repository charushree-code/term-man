 ...
 */
static void detect_pacman_collision(Map *map, Pacman *pacman, Position *new_pos) {
 ...
 * -1:  out of bounds
 */
static int collision(Terrain terrain) {
    switch (terrain) {
    case PATH: return 0;
    case FREE: return 0;
    case FOOD: return 0;
 ...
 * -1:  out of bounds
 */
static int detect_collision(Map *map, Position *pos) {
 ...
 */
static int detect_collision_coords(Map *map, int x, int y) {
 ...
 */
static void set_object(Map *map, Position *pos, Terrain terrain) {
 ...
 */
static Terrain get_object(Map *map, Position *pos) {
 ...
 */
static unsigned char draw_terrain(Terrain terrain) {
    unsigned char out;
 ...
 */
static void get_map_level(Map *map) {
    unsigned char i, j;
 ...
 * 1:   intersection
 */
static int intersection(Map *map, Position *pos) {
