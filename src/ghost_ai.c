...
void set_path(Ghost *ghost, Map *map) {
    ...
    Position new_pos = ghost->next_position(ghost, &map->dims);
    int x_wrap;
 ...
 */
static void set_target_blinky(Ghost *ghost, Pacman *pacman) {
 ...
 */
static void set_target_pinky(Ghost *ghost, Pacman *pacman, Dimension *dims) {
    Position pos;
    switch (pacman->dir) {
    case LEFT:
 ...
 */
static void set_target_inky(Ghost *ghost, Pacman *pacman, Ghost *blinky, Dimension *dims) {
    Position int_tile, targ_tile;
    switch (pacman->dir) {
    case LEFT:
 ...
 */
static void set_target_clyde(Ghost *ghost, Pacman *pacman, Dimension *dims) {
